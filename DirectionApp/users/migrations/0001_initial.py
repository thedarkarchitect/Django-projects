    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('town', models.CharField(blank=True, max_length=200, null=True, verbose_name='Town/City')),
                ('county', models.CharField(blank=True, max_length=200, null=True, verbose_name='County')),
